...
const JqlImportSection = ({
  ...
  // Common JQL examples
  const jqlExamples = [
    { label: 'Active sprint', jql: 'sprint in openSprints()' },
    { label: 'My stories', jql: 'assignee = currentUser() AND type = Story' },
    { label: 'Unestimated', jql: '"Story Points" is EMPTY AND type = Story' }
  ];
